...
class StorageManager:
    ...
    # In the save_to_mongodb method, ensure metadata is properly handled:
    def save_to_mongodb(self, document_data: Dict[str, Any], original_file_path: str) -> bool:
        """Save processed document data to MongoDB"""
        try:
            ...
            document_record = {
                ...
                "formatted_content": document_data.get("formatted_content", ""),
